...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID, this.getString(R.string.android_auto_update_notification_message), NotificationManager.IMPORTANCE_LOW);
            mChannel.setDescription(this.getString(R.string.android_auto_update_notify_ticker));
